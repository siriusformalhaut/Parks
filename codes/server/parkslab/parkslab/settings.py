"""
Django settings for parkslab project.
...
SECRET_KEY = '*0^sn=h(!6zry@^152d7wmjo_q0c_siu0awb0k%36a%%9sdwf%'
...
WSGI_APPLICATION = 'parkslab.wsgi.application'
...
STAITC_ROOT = os.path.join(BASE_DIR, 'assets')
